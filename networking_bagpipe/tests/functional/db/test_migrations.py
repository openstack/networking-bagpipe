...
from networking_bagpipe.db.models import head

EXTERNAL_TABLES = set(external.TABLES)
VERSION_TABLE = 'alembic_version_bagpipel2'


class _TestModelsMigrationsBaGPipe(test_migrations._TestModelsMigrations):
